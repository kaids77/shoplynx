    ...
    <div class="checkout-container">
        <form action="{{ route('checkout.process') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="email" name="customer_email" id="customer_email" class="form-control" value="{{ Auth::user()->email }}" required>
            </div>
            <div class="form-group">
                <label for="customer_phone">Phone Number (11 digits)</label>
                <input type="tel" name="customer_phone" id="customer_phone" class="form-control" maxlength="11" pattern="[0-9]{11}" placeholder="09XXXXXXXXX" required>
            </div>
            <div class="form-group">
